...
class AddGlenPromotion extends StatefulWidget {

  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<AddGlenPromotion> {
  bool _loading = false;
    ...
    try {
      resultList = await MultiImagePicker.pickImages(
        ...
        materialOptions: MaterialOptions(
          actionBarTitle: "Add Company Promotion",
          useDetailsView: true,
        ),
      );
