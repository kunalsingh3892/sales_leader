...
import 'expense_approved.dart';
import 'expense_pending.dart';
import 'follow_leads.dart';
import 'misc_expense.dart';
import 'my_tours.dart';

class AllExpense extends StatefulWidget {
  final Object argument;

  const AllExpense({Key key, this.argument}) : super(key: key);
  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<AllExpense>  with SingleTickerProviderStateMixin{
  bool _loading = false;
    ...
    return Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: Container(
            ...
            child:AppBar(
              title: Text("Expense Reimbursements",style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
        ...
        body:  TabBarView(
          ...
          children: <Widget>[
            ...
            ExpensePending(member_id),
            ExpenseApproved(member_id),
            Miscellaneous(member_id),
