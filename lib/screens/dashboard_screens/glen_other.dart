...
class GlenOtherLeads extends StatefulWidget {
  final String recordName;
  GlenOtherLeads(this.recordName);
  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<GlenOtherLeads>  with SingleTickerProviderStateMixin{
  bool _loading = false;
  ...
  Future _leadData() async {
    var response = await http.post(URL+"getleadlist",
      body: {
        ...
        "status":"Glen Purchase Other Store",
      },
      headers: {
