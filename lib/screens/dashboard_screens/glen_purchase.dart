...
class GlenPurchaseLeads extends StatefulWidget {
  final String recordName;
  GlenPurchaseLeads(this.recordName);
  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<GlenPurchaseLeads>  with SingleTickerProviderStateMixin{
  bool _loading = false;
