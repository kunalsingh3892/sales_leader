...
class _ResetPinState extends State<InfluencerList>
  ...
  Widget leadList(Size deviceSize) {
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          if(snapshot.data['influancer_list'].length!=0) {
          return Container(
            // color: Colors.red,
            ...
            child: ListView.builder(
                shrinkWrap: true,
                primary: false,
                itemCount: snapshot.data['influancer_list'].length,
                          ...
                          onTap: () {
                            Navigator.pushNamed(
                              ...
                              arguments: <String, String>{
                                'dealer_id': snapshot.data['influancer_list'][index]['id'].toString(),
                            ...
                            child: Row(
                                ...
                                children: <Widget>[
                                  CircleAvatar(
                                    ...
                                    child: Center(
                                      child: Text(
                                        snapshot.data['influancer_list'][index]
