...
class LocalDAList extends StatefulWidget {

  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<LocalDAList>
  ...
  Future _leadData(String mon,String year ) async {
    var response = await http.post(
      _localDA=="Per Km"? URL+"localDAKm_wise":URL+"localDAFixed_wise",
      body: {
       ...
       Container(
        ...
        InkWell(
          onTap: (){
            ...
            _localDA=="Per Km"?Navigator.pushNamed(
              context,
              '/attendance',
        ...
        _localDA!='null'?  Container(
            ...
            child: Container(
                ...
                child: AutoSizeText("\u20B9 " +result['amount'].toString(),
                    textAlign: TextAlign.center,
                    maxLines: 3,
                    style: TextStyle(color: Colors.black)))):Container(child: AutoSizeText(result['attendence_status'].toString(),
            textAlign: TextAlign.center,
            maxLines: 1,
            style: TextStyle(
        ...
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          return Column(
              children: <Widget>[
                                  ...
                                  child:_localDA=="Per Km"? Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(children: <Widget>[
                                        Expanded(
                                          child: snapshot
                                      .data['user_Km_price']!=null?Text(
                                              "Per Km Price: " +
                                                  "\u20B9 " +snapshot
                                                      .data['user_Km_price'].toString(),
                                              overflow:
                                      ...
                                      Row(children: <Widget>[
                                        Expanded(
                                          child: Text(
                                              "Total Distance: " +
                                                  snapshot
                                                      .data['total_km_distance'].toString(),
                                              overflow:
                                              TextOverflow.ellipsis,
                                              maxLines: 1,
                                              style: normalText
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(children: <Widget>[
                                        Expanded(
                                          child: snapshot.data['user_fixed_price']!=null?Text(
                                              "Total Fixed Price: " +
                                                  "₹"+total_fixed_price.toString(),
                                              overflow:
                                              TextOverflow.ellipsis,
                                              maxLines: 1,
                                              style: normalText
                                      ...
                                      Row(children: <Widget>[
                                        Expanded(
                                          child: Text(
                                              "Total Fixed time: " +
                                                  snapshot
                                                  .data['total_fixed_time'].toString(),
                                              overflow:
                                              TextOverflow.ellipsis,
                                              maxLines: 1,
                                              style: normalText
                      ...
                      TableRow(
                        ...
                        _localDA!='null'?    Container(
                                ...
                                child: AutoSizeText('Amount',
                                    ...
                                    maxLines: 2,
                                    style: TextStyle(
                                        fontWeight: FontWeight.w500,color: Colors.white))):Container(child: AutoSizeText('DA',
                            textAlign: TextAlign.center,
                            maxLines: 2,
                            style: TextStyle(
                                fontWeight: FontWeight.w500,color: Colors.white)),),
                ...
                _localDA=="Per Km"? snapshot.data['local_DA_list'].length!=0? Container(
                ...
                ):_emptyOrders():snapshot.data['local_DA_list'].length!=0? Container(
                  padding: EdgeInsets.symmetric(vertical: 3),
                  child: Table(
                    border: TableBorder.symmetric(
                        inside: BorderSide(width: 1, color: Colors.grey[300]),
