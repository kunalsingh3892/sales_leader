...
import 'my_dealerlist.dart';
import 'my_distributorlist.dart';
import 'my_tours.dart';

class MyDealers extends StatefulWidget {
  final Object argument;

  const MyDealers({Key key, this.argument}) : super(key: key);
  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<MyDealers>  with SingleTickerProviderStateMixin{
  bool _loading = false;
    ...
    return Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: Container(
            ...
            child:AppBar(
              title: Text("My Dealers/Distributors",style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
        ...
        body:  TabBarView(
          ...
          children: <Widget>[
            ...
            MyDealerList(member_id),
            MyDistributorList(member_id),
