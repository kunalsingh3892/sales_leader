...
import 'package:glen_lms/screens/dashboard_screens/wrong_assign.dart';
...
import 'glen_other.dart';
import 'glen_purchase.dart';
import 'junk_leads.dart';
import 'lead_lost.dart';
import 'not_interested_leads.dart';
import 'other_brand.dart';

class MyLeads extends StatefulWidget {
  final Object argument;

  const MyLeads({Key key, this.argument}) : super(key: key);
  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<MyLeads>  with SingleTickerProviderStateMixin{
  bool _loading = false;
...
*/
           ...
           /*   IconButton(
            ...
            bottom: TabBar(
              ...
              tabs: <Widget>[
               ...
               /* Tab(
                  text: "Glen Purchase Other Store",
                ),
                Tab(
                  text: "Other Brand Purchase",
                )*/
              ],
              onTap: (int val) {
      ...
      body:  TabBarView(
        ...
        children: <Widget>[
          ...
          MyAllLeads( member_id),
          MyFollowLeads(member_id),
          MyCompletedLeads(member_id),
         /* GlenPurchaseLeads(member_id),
          JunkLeads(member_id),
          NotInterestedLeads(member_id),*/
          LostLeads(member_id),
          WrongLeads(member_id),
         /* GlenOtherLeads(member_id),
          OtherBrandLeads(member_id),*/
