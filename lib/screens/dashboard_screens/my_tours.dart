...
class MyTours extends StatefulWidget {
  ...
  MyTours(this.recordName);
  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<MyTours>  with SingleTickerProviderStateMixin{
  bool _loading = false;
                                  ...
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        /*  snapshot.data['tour_plan_list'][index]['status']=="Approved"?  Material(
