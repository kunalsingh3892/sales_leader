...
class OtherBrandLeads extends StatefulWidget {
  final String recordName;
  OtherBrandLeads(this.recordName);
  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<OtherBrandLeads>  with SingleTickerProviderStateMixin{
  bool _loading = false;
