...
import 'package:glen_lms/screens/dashboard_screens/pending_for_approval_tour1.dart';
import 'package:glen_lms/screens/dashboard_screens/pending_for_approval_tour2.dart';
import 'package:glen_lms/screens/dashboard_screens/pending_tours.dart';
import 'package:glen_lms/screens/dashboard_screens/team_approveexpense.dart';
...
class PendingForApprovalTours extends StatefulWidget {
  final Object argument;

  const PendingForApprovalTours({Key key, this.argument}) : super(key: key);
  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<PendingForApprovalTours>  with SingleTickerProviderStateMixin{
  bool _loading = false;
    ...
    return Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: Container(
            ...
            child:AppBar(
              title: Text("My Team Tours",style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
        ...
        body:  TabBarView(
          ...
          children: <Widget>[
            ...
            TeamPendingTours(member_id),
            TeamApprovedTours(member_id),
