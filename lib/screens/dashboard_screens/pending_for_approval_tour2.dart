...
class TeamApprovedTours extends StatefulWidget {
  final String recordName;
  TeamApprovedTours(this.recordName);
  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<TeamApprovedTours>  with SingleTickerProviderStateMixin{
  bool _loading = false;
