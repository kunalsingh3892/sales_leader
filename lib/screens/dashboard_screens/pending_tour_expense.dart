...
class PendingTours1 extends StatefulWidget {
  final Object argument;

  const PendingTours1({Key key, this.argument}) : super(key: key);
  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<PendingTours1>  with SingleTickerProviderStateMixin{
  bool _loading = false;
    ...
    return Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: Container(
            ...
            child:AppBar(
              title: Text("Tours Expense",style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
