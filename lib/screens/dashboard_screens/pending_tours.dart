...
class PendingTours extends StatefulWidget {
  final String recordName;
  PendingTours(this.recordName);
  @override
  _ResetPinState createState() => _ResetPinState();
}

class _ResetPinState extends State<PendingTours>  with SingleTickerProviderStateMixin{
  bool _loading = false;
  ...
  Future _leadData() async {
    var response = await http.post(URL+"tourplanlists",
      body: {
  ...
  Widget leadList(Size deviceSize){
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData)
        {
          if(snapshot.data['tour_plan_list'].length!=0) {
            return  Container(
              // color: Colors.red,
              ...
              child: ListView.builder(
                  shrinkWrap: true,
                  primary: false,
                  itemCount: snapshot.data['tour_plan_list'].length,
                              ...
                              child: Row(
                                  ...
                                  children: <Widget>[
                                    CircleAvatar(
                                      ...
                                      child: Center(
                                        child: Text(
                                          snapshot.data['tour_plan_list'][index]['tour_tittle'][0].toUpperCase(),
                                        ...
                                        children: <Widget>[
                                          ...
                                          Row(
                                            ...
                                            children: <Widget>[
                                              Expanded(
                                                child: Text(
                                                  snapshot.data['tour_plan_list'][index]['tour_tittle'],
                                                  overflow:
                                              ...
                                              Text(
                                                'TOUR ID : ' + snapshot.data['tour_plan_list'][index]['tour_id'],
                                                style: TextStyle(
                                                  fontWeight: FontWeight.w500,
                                                  fontSize: 14.0,
                                                ),
                                          ...
                                          Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Text(
                                                  'Start Date : ' +snapshot.data['tour_plan_list'][index]['start_date_time'],
                                                  style: TextStyle(
                                                    fontWeight: FontWeight.w500,
                                                    fontSize: 10.0,
                                                  ),
                                          ...
                                          Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Text(
                                                  'End Date : ' +snapshot.data['tour_plan_list'][index]['end_date_time'],
                                                  style: TextStyle(
                                                    fontWeight: FontWeight.w500,
                                                    fontSize: 10.0,
                                                  ),
                                          ...
                                          Row(
                                              ...
                                              children: <Widget>[
                                                Expanded(
                                                  child: Text(
                                                    "Created by: " +snapshot.data['tour_plan_list'][index]['created_by'],
                                                    style: TextStyle(
                                                      fontWeight: FontWeight.w500,
                                                      fontSize: 14.0,
                                                    ),
                                                ...
                                                snapshot.data['tour_plan_list'][index]['extend_tour']=="Yes"?  Text(
                                                  ...
                                                  'Status : ' +snapshot.data['tour_plan_list'][index]['status'],
                                                  style: TextStyle(
                                                    fontWeight: FontWeight.w500,
                                                    fontSize: 10.0,
                                                  ),
